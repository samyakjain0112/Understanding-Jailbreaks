...
class Trainer:
    ...
    def __init__(self, config, model, train_dataset, val_dataset,test_dataset_unsafe, test_dataset_safe, test_dataset_intermediate, test_dataset_all, test_dataset_duplicate, test_dataset_id_mg, test_dataset_ood_mg):
        self.config = config
        self.model = model
        self.optimizer = None
    ...
    def run_pretrain(self):
        ...
        while True:
            ...
            x_safe_cap, x_unsafe_cap, x_unsafe_cap_target, y_safe_cap, y_unsafe_cap, y_unsafe_cap_target, mask, start_idx, end_idx, idx, idx1, idx2, idx3, idx_clm, safety_label, _ = batch
            ...
            if self.config.is_dpo==1:
                logits, self.loss_safe = model(x,y,mask)
                logits_unsafe, self.loss_unsafe = model(x_unsafe_cap_target,y_unsafe_cap_target,mask)

                logits_dpo, self.loss_safe_dpo = self.config.dpo_model(x,y,mask)
                logits_unsafe_dpo, self.loss_unsafe_dpo = self.config.dpo_model(x_unsafe_cap_target,y_unsafe_cap_target,mask)

                self.loss = (self.loss_safe-self.loss_safe_dpo.detach())*self.config.dpo_weight_safe - (self.loss_unsafe-self.loss_unsafe_dpo.detach())*self.config.dpo_weight_unsafe
            ...
            counter_safebranch_unsafecap=0
            ...
            counter_safebranch_unsafecap_tar=0
            ...
            counter_unsafebranch_safecap=0
            ...
            counter_unsafebranch_unsafecap=0
            ...
            counter_unsafebranch_unsafecap_tar=0
            ...
            for i in range(y.shape[0]):
                ...
                if safety_label[i]==1 and random_pick==0:
                    ...
                    counter_safebranch_unsafecap+=1
                    if torch.sum(acc_temp) == (end_idx[i][-1]-start_idx[i]):
                ...
                if (safety_label[i]==0 or safety_label[i]==5)  and random_pick==1:
                    ...
                    counter_unsafebranch_safecap+=1
                    if torch.sum(acc_temp) == (end_idx[i][-1]-start_idx[i]):
                ...
                if (safety_label[i]==0 or safety_label[i]==5) and random_pick==0:
                    ...
                    counter_unsafebranch_unsafecap+=1
                    if torch.sum(acc_temp) == (end_idx[i][-1]-start_idx[i]):
            ...
            if counter_safebranch_safecap==0:
                counter_safebranch_safecap=1
            if counter_safebranch_unsafecap==0:
                counter_safebranch_unsafecap=1
            if counter_unsafebranch_unsafecap==0:
                counter_unsafebranch_unsafecap=1
            if counter_unsafebranch_safecap==0:
                counter_unsafebranch_safecap=1

            acc_iter_safebranch_safecap = acc_safebranch_safecap/counter_safebranch_safecap
            acc_idx1_iter_safebranch_safecap = acc_idx1_safebranch_safecap/counter_safebranch_safecap
            acc_idx2_iter_safebranch_safecap = acc_idx2_safebranch_safecap/counter_safebranch_safecap
            acc_comb1_iter_safebranch_safecap = acc_comb1_safebranch_safecap/counter_safebranch_safecap
            acc_comb2_iter_safebranch_safecap = acc_comb2_safebranch_safecap/counter_safebranch_safecap
            acc_comb_iter_safebranch_safecap = acc_comb_safebranch_safecap/counter_safebranch_safecap



            acc_iter_safebranch_unsafecap = acc_safebranch_unsafecap/counter_safebranch_unsafecap
            acc_idx1_iter_safebranch_unsafecap = acc_idx1_safebranch_unsafecap/counter_safebranch_unsafecap
            acc_idx2_iter_safebranch_unsafecap = acc_idx2_safebranch_unsafecap/counter_safebranch_unsafecap
            acc_comb1_iter_safebranch_unsafecap = acc_comb1_safebranch_unsafecap/counter_safebranch_unsafecap
            acc_comb2_iter_safebranch_unsafecap = acc_comb2_safebranch_unsafecap/counter_safebranch_unsafecap
            acc_comb_iter_safebranch_unsafecap = acc_comb_safebranch_unsafecap/counter_safebranch_unsafecap


            acc_iter_unsafebranch_unsafecap = acc_unsafebranch_unsafecap/counter_unsafebranch_unsafecap
            acc_idx1_iter_unsafebranch_unsafecap = acc_idx1_unsafebranch_unsafecap/counter_unsafebranch_unsafecap
            acc_idx2_iter_unsafebranch_unsafecap = acc_idx2_unsafebranch_unsafecap/counter_unsafebranch_unsafecap
            acc_comb1_iter_unsafebranch_unsafecap = acc_comb1_unsafebranch_unsafecap/counter_unsafebranch_unsafecap
            acc_comb2_iter_unsafebranch_unsafecap = acc_comb2_unsafebranch_unsafecap/counter_unsafebranch_unsafecap
            acc_comb_iter_unsafebranch_unsafecap = acc_comb_unsafebranch_unsafecap/counter_unsafebranch_unsafecap


            acc_iter_safebranch_unsafecap_tar = acc_safebranch_unsafecap_tar/counter_safebranch_unsafecap
            acc_idx1_iter_safebranch_unsafecap_tar = acc_idx1_safebranch_unsafecap_tar/counter_safebranch_unsafecap
            acc_idx2_iter_safebranch_unsafecap_tar = acc_idx2_safebranch_unsafecap_tar/counter_safebranch_unsafecap
            acc_comb1_iter_safebranch_unsafecap_tar = acc_comb1_safebranch_unsafecap_tar/counter_safebranch_unsafecap
            acc_comb2_iter_safebranch_unsafecap_tar = acc_comb2_safebranch_unsafecap_tar/counter_safebranch_unsafecap
            acc_comb_iter_safebranch_unsafecap_tar = acc_comb_safebranch_unsafecap_tar/counter_safebranch_unsafecap


            acc_iter_unsafebranch_unsafecap_tar = acc_unsafebranch_unsafecap_tar/counter_unsafebranch_unsafecap
            acc_idx1_iter_unsafebranch_unsafecap_tar = acc_idx1_unsafebranch_unsafecap_tar/counter_unsafebranch_unsafecap
            acc_idx2_iter_unsafebranch_unsafecap_tar = acc_idx2_unsafebranch_unsafecap_tar/counter_unsafebranch_unsafecap
            acc_comb1_iter_unsafebranch_unsafecap_tar = acc_comb1_unsafebranch_unsafecap_tar/counter_unsafebranch_unsafecap
            acc_comb2_iter_unsafebranch_unsafecap_tar = acc_comb2_unsafebranch_unsafecap_tar/counter_unsafebranch_unsafecap
            acc_comb_iter_unsafebranch_unsafecap_tar = acc_comb_unsafebranch_unsafecap_tar/counter_unsafebranch_unsafecap

 
            acc_iter_unsafebranch_safecap = acc_unsafebranch_safecap/counter_unsafebranch_safecap
            acc_idx1_iter_unsafebranch_safecap = acc_idx1_unsafebranch_safecap/counter_unsafebranch_safecap
            acc_idx2_iter_unsafebranch_safecap = acc_idx2_unsafebranch_safecap/counter_unsafebranch_safecap
            acc_comb1_iter_unsafebranch_safecap = acc_comb1_unsafebranch_safecap/counter_unsafebranch_safecap
            acc_comb2_iter_unsafebranch_safecap = acc_comb2_unsafebranch_safecap/counter_unsafebranch_safecap
            acc_comb_iter_unsafebranch_safecap = acc_comb_unsafebranch_safecap/counter_unsafebranch_safecap
            ...
            if self.iter_num%config.test_evaluate_iter==0 or self.iter_num==1:   
                loss_iter_dict, acc_iter_dict, acc_pcfg_iter_dict, acc_idx1_iter_dict, acc_idx2_iter_dict, acc_comb1_iter_dict, acc_comb2_iter_dict, acc_comb_iter_dict = self.evaluate_pretrain(model, test_loader_safe, test_loader_unsafe, test_loader_intermediate, test_loader_all, test_loader_duplicate, test_loader_id_mg, test_loader_ood_mg, max_iterations=config.max_test_iters, attack_lst=attack_lst)   

                wandb.log({'Loss Std Sfe Brch (Sfe Cp) (Test)': loss_iter_dict['loss_safe_std'][0]},step=self.iter_num)
                wandb.log({'Loss Std Sfe Brch (USfe Cp) (Test)': loss_iter_dict['loss_safe_std'][1]},step=self.iter_num)
                wandb.log({'Loss Std Sfe Brch (USfe Trg Cp) (Test)': loss_iter_dict['loss_safe_std'][2]},step=self.iter_num)
                wandb.log({'Acc Next Token PCFG (Test)': acc_pcfg_iter_dict['acc_safe_pcfg_std']},step=self.iter_num)

                wandb.log({'Acc Std Cp 1,2 Sfe Brch (Sfe Cp) (Test)': acc_iter_dict['acc_safe_std'][0]},step=self.iter_num)
                wandb.log({'Acc Std Cp 1,2 Sfe Brch (USfe Cp) (Test)': acc_iter_dict['acc_safe_std'][1]},step=self.iter_num)
                wandb.log({'Acc Std Cp 1,2 Sfe Brch (USfe Trg Cp) (Test)': acc_iter_dict['acc_safe_std'][2]},step=self.iter_num)
            
                wandb.log({'Acc Std Cp 1 Sfe Brch (Sfe Cp) (Test)': acc_idx1_iter_dict['acc_safe_idx1_std'][0]},step=self.iter_num)
                wandb.log({'Acc Std Cp 1 Sfe Brch (USfe Cp) (Test)': acc_idx1_iter_dict['acc_safe_idx1_std'][1]},step=self.iter_num)
                wandb.log({'Acc Std Cp 1 Sfe Brch (USfe Trg Cp) (Test)': acc_idx1_iter_dict['acc_safe_idx1_std'][2]},step=self.iter_num)

                wandb.log({'Acc Std Cp 2 Sfe Brch (Sfe Cp) (Test)': acc_idx2_iter_dict['acc_safe_idx2_std'][0]},step=self.iter_num)
                wandb.log({'Acc Std Cp 2 Sfe Brch (USfe Cp) (Test)': acc_idx2_iter_dict['acc_safe_idx2_std'][1]},step=self.iter_num)
                wandb.log({'Acc Std Cp 2 Sfe Brch (USfe Trg Cp) (Test)': acc_idx2_iter_dict['acc_safe_idx2_std'][2]},step=self.iter_num)
    
                wandb.log({'Acc Std Cp 1 AND Sfe Brch (Sfe Cp) (Test)': acc_comb1_iter_dict['acc_safe_comb1_std'][0]},step=self.iter_num)
                wandb.log({'Acc Std Cp 1 AND Sfe Brch (USfe Cp) (Test)': acc_comb1_iter_dict['acc_safe_comb1_std'][1]},step=self.iter_num)
                wandb.log({'Acc Std Cp 1 AND Sfe Brch (USfe Trg Cp) (Test)': acc_comb1_iter_dict['acc_safe_comb1_std'][2]},step=self.iter_num)

                wandb.log({'Acc Std Cp 2 AND Sfe Brch (Sfe Cp) (Test)': acc_comb2_iter_dict['acc_safe_comb2_std'][0]},step=self.iter_num)
                wandb.log({'Acc Std Cp 2 AND Sfe Brch (USfe Cp) (Test)': acc_comb2_iter_dict['acc_safe_comb2_std'][1]},step=self.iter_num)
                wandb.log({'Acc Std Cp 2 AND Sfe Brch (USfe Trg Cp) (Test)': acc_comb2_iter_dict['acc_safe_comb2_std'][2]},step=self.iter_num)

                wandb.log({'Acc Std Cp 1,2 AND Sfe Brch (Sfe Cp) (Test)': acc_comb_iter_dict['acc_safe_comb_std'][0]},step=self.iter_num)
                wandb.log({'Acc Std Cp 1,2 AND Sfe Brch (USfe Cp) (Test)': acc_comb_iter_dict['acc_safe_comb_std'][1]},step=self.iter_num)
                wandb.log({'Acc Std Cp 1,2 AND Sfe Brch (USfe Trg Cp) (Test)': acc_comb_iter_dict['acc_safe_comb_std'][2]},step=self.iter_num)
 




                wandb.log({'Loss Std USfe Brch (Sfe Cp) (Test)': loss_iter_dict['loss_unsafe_std'][0]},step=self.iter_num)
                wandb.log({'Loss Std USfe Brch (USfe Cp) (Test)': loss_iter_dict['loss_unsafe_std'][1]},step=self.iter_num)
                wandb.log({'Loss Std USfe Brch (USfe Trg Cp) (Test)': loss_iter_dict['loss_unsafe_std'][2]},step=self.iter_num)
                wandb.log({'Acc Next Token PCFG (Test)': acc_pcfg_iter_dict['acc_unsafe_pcfg_std']},step=self.iter_num)

                wandb.log({'Acc Std Cp 1,2 USfe Brch (Sfe Cp) (Test)': acc_iter_dict['acc_unsafe_std'][0]},step=self.iter_num)
                wandb.log({'Acc Std Cp 1,2 USfe Brch (USfe Cp) (Test)': acc_iter_dict['acc_unsafe_std'][1]},step=self.iter_num)
                wandb.log({'Acc Std Cp 1,2 USfe Brch (USfe Trg Cp) (Test)': acc_iter_dict['acc_unsafe_std'][2]},step=self.iter_num)
            
                wandb.log({'Acc Std Cp 1 USfe Brch (Sfe Cp) (Test)': acc_idx1_iter_dict['acc_unsafe_idx1_std'][0]},step=self.iter_num)
                wandb.log({'Acc Std Cp 1 USfe Brch (USfe Cp) (Test)': acc_idx1_iter_dict['acc_unsafe_idx1_std'][1]},step=self.iter_num)
                wandb.log({'Acc Std Cp 1 USfe Brch (USfe Trg Cp) (Test)': acc_idx1_iter_dict['acc_unsafe_idx1_std'][2]},step=self.iter_num)

                wandb.log({'Acc Std Cp 2 USfe Brch (Sfe Cp) (Test)': acc_idx2_iter_dict['acc_unsafe_idx2_std'][0]},step=self.iter_num)
                wandb.log({'Acc Std Cp 2 USfe Brch (USfe Cp) (Test)': acc_idx2_iter_dict['acc_unsafe_idx2_std'][1]},step=self.iter_num)
                wandb.log({'Acc Std Cp 2 USfe Brch (USfe Trg Cp) (Test)': acc_idx2_iter_dict['acc_unsafe_idx2_std'][2]},step=self.iter_num)
    
                wandb.log({'Acc Std Cp 1 AND USfe Brch (Sfe Cp) (Test)': acc_comb1_iter_dict['acc_unsafe_comb1_std'][0]},step=self.iter_num)
                wandb.log({'Acc Std Cp 1 AND USfe Brch (USfe Cp) (Test)': acc_comb1_iter_dict['acc_unsafe_comb1_std'][1]},step=self.iter_num)
                wandb.log({'Acc Std Cp 1 AND USfe Brch (USfe Trg Cp) (Test)': acc_comb1_iter_dict['acc_unsafe_comb1_std'][2]},step=self.iter_num)

                wandb.log({'Acc Std Cp 2 AND USfe Brch (Sfe Cp) (Test)': acc_comb2_iter_dict['acc_unsafe_comb2_std'][0]},step=self.iter_num)
                wandb.log({'Acc Std Cp 2 AND USfe Brch (USfe Cp) (Test)': acc_comb2_iter_dict['acc_unsafe_comb2_std'][1]},step=self.iter_num)
                wandb.log({'Acc Std Cp 2 AND USfe Brch (USfe Trg Cp) (Test)': acc_comb2_iter_dict['acc_unsafe_comb2_std'][2]},step=self.iter_num)

                wandb.log({'Acc Std Cp 1,2 AND USfe Brch (Sfe Cp) (Test)': acc_comb_iter_dict['acc_unsafe_comb_std'][0]},step=self.iter_num)
                wandb.log({'Acc Std Cp 1,2 AND USfe Brch (USfe Cp) (Test)': acc_comb_iter_dict['acc_unsafe_comb_std'][1]},step=self.iter_num)
                wandb.log({'Acc Std Cp 1,2 AND USfe Brch (USfe Trg Cp) (Test)': acc_comb_iter_dict['acc_unsafe_comb_std'][2]},step=self.iter_num)
 



                wandb.log({'Loss JB MG Txt (Sfe Cp) (Test)': loss_iter_dict['loss_jail_mg_text'][0]},step=self.iter_num)
                wandb.log({'Loss JB MG Txt (USfe Cp) (Test)': loss_iter_dict['loss_jail_mg_text'][1]},step=self.iter_num)
                wandb.log({'Loss JB MG Txt (USfe Trg Cp) (Test)': loss_iter_dict['loss_jail_mg_text'][2]},step=self.iter_num)

                wandb.log({'Acc JB MG Txt Cp 1,2 (Sfe Cp) (Test)': acc_iter_dict['acc_jail_mg_text'][0]},step=self.iter_num)
                wandb.log({'Acc JB MG Txt Cp 1,2 (USfe Cp) (Test)': acc_iter_dict['acc_jail_mg_text'][1]},step=self.iter_num)
                wandb.log({'Acc JB MG Txt Cp 1,2 (USfe Trg Cp) (Test)': acc_iter_dict['acc_jail_mg_text'][2]},step=self.iter_num)
            
                wandb.log({'Acc JB MG Txt Cp 1 (Sfe Cp) (Test)': acc_idx1_iter_dict['acc_idx1_jail_mg_text'][0]},step=self.iter_num)
                wandb.log({'Acc JB MG Txt Cp 1 (USfe Cp) (Test)': acc_idx1_iter_dict['acc_idx1_jail_mg_text'][1]},step=self.iter_num)
                wandb.log({'Acc JB MG Txt Cp 1 (USfe Trg Cp) (Test)': acc_idx1_iter_dict['acc_idx1_jail_mg_text'][2]},step=self.iter_num)

                wandb.log({'Acc JB MG Txt Cp 2 (Sfe Cp) (Test)': acc_idx2_iter_dict['acc_idx2_jail_mg_text'][0]},step=self.iter_num)
                wandb.log({'Acc JB MG Txt Cp 2 (USfe Cp) (Test)': acc_idx2_iter_dict['acc_idx2_jail_mg_text'][1]},step=self.iter_num)
                wandb.log({'Acc JB MG Txt Cp 2 (USfe Trg Cp) (Test)': acc_idx2_iter_dict['acc_idx2_jail_mg_text'][2]},step=self.iter_num)
    
                wandb.log({'Acc JB MG Txt Cp 1 AND (Sfe Cp) (Test)': acc_comb1_iter_dict['acc_comb1_jail_mg_text'][0]},step=self.iter_num)
                wandb.log({'Acc JB MG Txt Cp 1 AND (USfe Cp) (Test)': acc_comb1_iter_dict['acc_comb1_jail_mg_text'][1]},step=self.iter_num)
                wandb.log({'Acc JB MG Txt Cp 1 AND (USfe Trg Cp) (Test)': acc_comb1_iter_dict['acc_comb1_jail_mg_text'][2]},step=self.iter_num)

                wandb.log({'Acc JB MG Txt Cp 2 AND (Sfe Cp) (Test)': acc_comb2_iter_dict['acc_comb2_jail_mg_text'][0]},step=self.iter_num)
                wandb.log({'Acc JB MG Txt Cp 2 AND (USfe Cp) (Test)': acc_comb2_iter_dict['acc_comb2_jail_mg_text'][1]},step=self.iter_num)
                wandb.log({'Acc JB MG Txt Cp 2 AND (USfe Trg Cp) (Test)': acc_comb2_iter_dict['acc_comb2_jail_mg_text'][2]},step=self.iter_num)

                wandb.log({'Acc JB MG Txt Cp 1,2 AND (Sfe Cp) (Test)': acc_comb_iter_dict['acc_comb_jail_mg_text'][0]},step=self.iter_num)
                wandb.log({'Acc JB MG Txt Cp 1,2 AND (USfe Cp) (Test)': acc_comb_iter_dict['acc_comb_jail_mg_text'][1]},step=self.iter_num)
                wandb.log({'Acc JB MG Txt Cp 1,2 AND (USfe Trg Cp) (Test)': acc_comb_iter_dict['acc_comb_jail_mg_text'][2]},step=self.iter_num)




                wandb.log({'Loss JB MG Tkns (Duplicate Cap) (Test)': loss_iter_dict['loss_jail_mg_tokens'][0]},step=self.iter_num)
                wandb.log({'Loss JB MG Tkns (USfe Cp) (Test)': loss_iter_dict['loss_jail_mg_tokens'][1]},step=self.iter_num)
                wandb.log({'Loss JB MG Tkns (USfe Trg Cp) (Test)': loss_iter_dict['loss_jail_mg_tokens'][2]},step=self.iter_num)

                wandb.log({'Acc JB MG Tkns Cp 1,2 (Duplicate Cap) (Test)': acc_iter_dict['acc_jail_mg_tokens'][0]},step=self.iter_num)
                wandb.log({'Acc JB MG Tkns Cp 1,2 (USfe Cp) (Test)': acc_iter_dict['acc_jail_mg_tokens'][1]},step=self.iter_num)
                wandb.log({'Acc JB MG Tkns Cp 1,2 (USfe Trg Cp) (Test)': acc_iter_dict['acc_jail_mg_tokens'][2]},step=self.iter_num)
            
                wandb.log({'Acc JB MG Tkns Cp 1 (Duplicate Cap) (Test)': acc_idx1_iter_dict['acc_idx1_jail_mg_tokens'][0]},step=self.iter_num)
                wandb.log({'Acc JB MG Tkns Cp 1 (USfe Cp) (Test)': acc_idx1_iter_dict['acc_idx1_jail_mg_tokens'][1]},step=self.iter_num)
                wandb.log({'Acc JB MG Tkns Cp 1 (USfe Trg Cp) (Test)': acc_idx1_iter_dict['acc_idx1_jail_mg_tokens'][2]},step=self.iter_num)

                wandb.log({'Acc JB MG Tkns Cp 2 (Duplicate Cap) (Test)': acc_idx2_iter_dict['acc_idx2_jail_mg_tokens'][0]},step=self.iter_num)
                wandb.log({'Acc JB MG Tkns Cp 2 (USfe Cp) (Test)': acc_idx2_iter_dict['acc_idx2_jail_mg_tokens'][1]},step=self.iter_num)
                wandb.log({'Acc JB MG Tkns Cp 2 (USfe Trg Cp) (Test)': acc_idx2_iter_dict['acc_idx2_jail_mg_tokens'][2]},step=self.iter_num)
    
                wandb.log({'Acc JB MG Tkns Cp 1 AND (Duplicate Cap) (Test)': acc_comb1_iter_dict['acc_comb1_jail_mg_tokens'][0]},step=self.iter_num)
                wandb.log({'Acc JB MG Tkns Cp 1 AND (USfe Cp) (Test)': acc_comb1_iter_dict['acc_comb1_jail_mg_tokens'][1]},step=self.iter_num)
                wandb.log({'Acc JB MG Tkns Cp 1 AND (USfe Trg Cp) (Test)': acc_comb1_iter_dict['acc_comb1_jail_mg_tokens'][2]},step=self.iter_num)

                wandb.log({'Acc JB MG Tkns Cp 2 AND (Duplicate Cap) (Test)': acc_comb2_iter_dict['acc_comb2_jail_mg_tokens'][0]},step=self.iter_num)
                wandb.log({'Acc JB MG Tkns Cp 2 AND (USfe Cp) (Test)': acc_comb2_iter_dict['acc_comb2_jail_mg_tokens'][1]},step=self.iter_num)
                wandb.log({'Acc JB MG Tkns Cp 2 AND (USfe Trg Cp) (Test)': acc_comb2_iter_dict['acc_comb2_jail_mg_tokens'][2]},step=self.iter_num)

                wandb.log({'Acc JB MG Tkns Cp 1,2 AND (Duplicate Cap) (Test)': acc_comb_iter_dict['acc_comb_jail_mg_tokens'][0]},step=self.iter_num)
                wandb.log({'Acc JB MG Tkns Cp 1,2 AND (USfe Cp) (Test)': acc_comb_iter_dict['acc_comb_jail_mg_tokens'][1]},step=self.iter_num)
                wandb.log({'Acc JB MG Tkns Cp 1,2 AND (USfe Trg Cp) (Test)': acc_comb_iter_dict['acc_comb_jail_mg_tokens'][2]},step=self.iter_num)



                wandb.log({'Loss JB CO (Sfe Cp) (Test)': loss_iter_dict['loss_jail_co'][0]},step=self.iter_num)
                wandb.log({'Loss JB CO (USfe Cp) (Test)': loss_iter_dict['loss_jail_co'][1]},step=self.iter_num)
                wandb.log({'Loss JB CO (USfe Trg Cp) (Test)': loss_iter_dict['loss_jail_co'][2]},step=self.iter_num)

                wandb.log({'Acc JB CO Cp 1,2 (Sfe Cp) (Test)': acc_iter_dict['acc_jail_co'][0]},step=self.iter_num)
                wandb.log({'Acc JB CO Cp 1,2 (USfe Cp) (Test)': acc_iter_dict['acc_jail_co'][1]},step=self.iter_num)
                wandb.log({'Acc JB CO Cp 1,2 (USfe Trg Cp) (Test)': acc_iter_dict['acc_jail_co'][2]},step=self.iter_num)
            
                wandb.log({'Acc JB CO Cp 1 (Sfe Cp) (Test)': acc_idx1_iter_dict['acc_idx1_jail_co'][0]},step=self.iter_num)
                wandb.log({'Acc JB CO Cp 1 (USfe Cp) (Test)': acc_idx1_iter_dict['acc_idx1_jail_co'][1]},step=self.iter_num)
                wandb.log({'Acc JB CO Cp 1 (USfe Trg Cp) (Test)': acc_idx1_iter_dict['acc_idx1_jail_co'][2]},step=self.iter_num)

                wandb.log({'Acc JB CO Cp 2 (Sfe Cp) (Test)': acc_idx2_iter_dict['acc_idx2_jail_co'][0]},step=self.iter_num)
                wandb.log({'Acc JB CO Cp 2 (USfe Cp) (Test)': acc_idx2_iter_dict['acc_idx2_jail_co'][1]},step=self.iter_num)
                wandb.log({'Acc JB CO Cp 2 (USfe Trg Cp) (Test)': acc_idx2_iter_dict['acc_idx2_jail_co'][2]},step=self.iter_num)
    
                wandb.log({'Acc JB CO Cp 1 AND (Sfe Cp) (Test)': acc_comb1_iter_dict['acc_comb1_jail_co'][0]},step=self.iter_num)
                wandb.log({'Acc JB CO Cp 1 AND (USfe Cp) (Test)': acc_comb1_iter_dict['acc_comb1_jail_co'][1]},step=self.iter_num)
                wandb.log({'Acc JB CO Cp 1 AND (USfe Trg Cp) (Test)': acc_comb1_iter_dict['acc_comb1_jail_co'][2]},step=self.iter_num)

                wandb.log({'Acc JB CO Cp 2 AND (Sfe Cp) (Test)': acc_comb2_iter_dict['acc_comb2_jail_co'][0]},step=self.iter_num)
                wandb.log({'Acc JB CO Cp 2 AND (USfe Cp) (Test)': acc_comb2_iter_dict['acc_comb2_jail_co'][1]},step=self.iter_num)
                wandb.log({'Acc JB CO Cp 2 AND (USfe Trg Cp) (Test)': acc_comb2_iter_dict['acc_comb2_jail_co'][2]},step=self.iter_num)

                wandb.log({'Acc JB CO Cp 1,2 AND (Sfe Cp) (Test)': acc_comb_iter_dict['acc_comb_jail_co'][0]},step=self.iter_num)
                wandb.log({'Acc JB CO Cp 1,2 AND (USfe Cp) (Test)': acc_comb_iter_dict['acc_comb_jail_co'][1]},step=self.iter_num)
                wandb.log({'Acc JB CO Cp 1,2 AND (USfe Trg Cp) (Test)': acc_comb_iter_dict['acc_comb_jail_co'][2]},step=self.iter_num)
    ...
    def get_log(self,logits, y, loss, start_idx, end_idx, idx, idx1, idx2, idx3):
        ...
        acc_idx1_iter = acc_idx1/counter_acc
        acc_idx2_iter = acc_idx2/counter_acc
        acc_comb1_iter = acc_comb1/counter_acc
        acc_comb2_iter = acc_comb2/counter_acc
    ...
    def evaluate_pretrain(self, model, test_loader_safe, test_loader_unsafe, test_loader_intermediate, test_loader_all, test_loader_duplicate, test_loader_id_mg, test_loader_ood_mg, max_iterations=0,attack_lst=[]):
        model.eval()
        net_acc = 0.0
        net_acc_token = 0.0
        loss = 0.0
