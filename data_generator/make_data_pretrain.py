...
parser.add_argument('--train_data_path', type=str, default='./saved_data/pretrain_data_train_pcfg1.pkl')
parser.add_argument('--test_data_path', type=str, default='./saved_data/pretrain_data_test_pcfg1.pkl')
