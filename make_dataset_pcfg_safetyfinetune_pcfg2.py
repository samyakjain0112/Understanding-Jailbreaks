...
parser.add_argument('--train_data_path', type=str, default='./saved_data/safety_finetune_dataset_train_pcfg2.pkl')
parser.add_argument('--test_data_path', type=str, default='./saved_data/safety_finetune_dataset_test_pcfg2.pkl')
