...
parser.add_argument('--is_unlearn', default=0, type=int)
parser.add_argument('--unlearn_weight_safe', default=0, type=float)
parser.add_argument('--unlearn_weight_unsafe', default=0, type=float)
...
train_config.is_unlearn = args.is_unlearn
train_config.unlearn_weight_safe = args.unlearn_weight_safe
train_config.unlearn_weight_unsafe = args.unlearn_weight_unsafe
train_config.prob_unsafe = args.prob_unsafe
train_config.unlearn_model = model2
